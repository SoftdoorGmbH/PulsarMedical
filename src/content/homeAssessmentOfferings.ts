...
export const HOME_ASSESSMENT_OFFERINGS: AssessmentOffering[] = [
  {
    ...
    icon: Stethoscope,
    imageSrc:
      "/male-doctor-communicating-with-female-patient-while-using-touchpad-going-through-electronic-medical-reports.webp",
  ...
  },
  {
    ...
    icon: Brain,
    imageSrc: "/medium-shot-people-discussing.webp",
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    imageSrc: "/offers/meldeversauemnisse/business-men-discussing-project.webp",
