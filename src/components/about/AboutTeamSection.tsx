    ...
    >
      <div className="mx-auto max-w-6xl px-6 md:px-8 lg:px-10">
        <h2
          ...
          className="text-center text-3xl font-semibold tracking-tight text-pm-light-headline md:text-4xl"
        >
          Unser Team
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-center text-base leading-relaxed text-pm-light-text-1 md:text-lg">
          Ärztinnen, Psychologinnen, Beraterinnen und Assistenz — gemeinsam
          für ganzheitliche Gesundheitsberatung.
        </p>
